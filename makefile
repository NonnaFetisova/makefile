...
file0.o: file0.c file2.h file3.h
	$(CC) $(CFLAGS) -c file0.c

file1.o: file1.c file0.h file4.h
	$(CC) $(CFLAGS) -c file1.c
	
file2.o: file2.c file1.h file3.h
	$(CC) $(CFLAGS) -c file2.c
	
file3.o: file3.c file4.h 
	$(CC) $(CFLAGS) -c file3.c
	
file4.o: file4.c file0.h file1.h file2.h file3.h
	$(CC) $(CFLAGS) -c file4.c
